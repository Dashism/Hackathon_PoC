...
export class HomeComponent implements OnInit, OnDestroy {
    ...
    imageUrls: (string | IImage)[] = [
        ...
        { url: 'assets/images/14.png', caption: 'Vous avez des compétences ?' },
        { url: 'assets/images/16.png', caption: 'Vous souhaitez rejoindre <br/> un vrai réseau ?' },
        { url: 'assets/images/3.png', caption: 'Vous avez besoin de renfort ?' },
        { url: 'assets/images/17.png', caption: 'Vous ne savez pas  <br/> à qui vous adresser ?' },
